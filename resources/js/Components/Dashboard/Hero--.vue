...
<template>
    <div class="bg-slate-100 relative">
            ...
            <div>
                <div
                    ...
                    <div class="flex-1 flex items-center border-r">
                        ...
                        <input v-model="searchQuery" placeholder="Job title or keyword"
                    ...
                    <div class="flex-1 flex items-center">
                        ...
                        <input v-model="locationQuery" placeholder="Location"
                            class="py-4 shadow-none border-none focus:outline-none focus:ring-0 outline-none ring-0"
                            type="text">
                    </div>
        ...
        <div class="container py-5">
            <h2 class="text-2xl font-semibold mb-4">Filtered Job Openings</h2>
            <div v-if="filteredJobs().length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div v-for="job in filteredJobs()" :key="job.id" class="p-6 bg-white shadow rounded-lg">
